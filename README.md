...
**[v0.3.0-rc.2](https://github.com/mouse9527/pi-turn-fold/releases/tag/v0.3.0-rc.2) is the experimental candidate for Pi 0.85.1 only**, not a stable Latest release. The fixed tag becomes installable only after tag publication; the authoritative public status, verification evidence and known limits are on [GitHub Releases](https://github.com/mouse9527/pi-turn-fold/releases). The existing [v0.3.0-rc.1 prerelease](https://github.com/mouse9527/pi-turn-fold/releases/tag/v0.3.0-rc.1) remains available. Once the candidate tag is published, install this fixed version directly, without a local build:
