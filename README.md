...
**v0.3.0-rc.1 is an experimental prerelease for Pi 0.85.1 only**, not a stable Latest release. Check [GitHub Releases](https://github.com/mouse9527/pi-turn-fold/releases) for authoritative publication status and verification notes. This candidate is being prepared; the exact install command becomes available after its tag is published:
