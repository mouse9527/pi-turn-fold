...
> RC1 原准备基线为 `14b6f9217c90d771a189923a384670ffcbe2cb92`。本次 RC2 从 main 基线 `0f3d7fede7e6f3bce60a9ba47cf55f611f105604`（package version `0.2.1`）在隔离工作树的 `release/v0.3.0-rc.2` 分支准备；不修改开发工作树、用户安装或配置。RC2 tag 推送后才可安装，公开发布状态以 Releases 页面为准；现有 RC1 仍可用。
