...
const results = [];
for (const [calls, turns] of [[300, 1], [1000, 1], [10000, 1], [10000, 100]]) {
  ...
  results.push({ calls, turns, render_p50_ms: render.p50, render_p95_ms: render.p95, update_render_p95_ms: update.p95 });
